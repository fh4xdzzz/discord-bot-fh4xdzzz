...
async def ayuda(interaction: discord.Interaction):
    ...
    embed.add_field(name='🔒 Verificación', value='/config_verification, /create_verification_message, /manual_verify', inline=False)
    embed.add_field(name='🎉 Sorteos', value='/create_giveaway, /end_giveaway, /list_giveaways, /reroll_giveaway', inline=False)
    embed.add_field(name='🔔 Notificaciones', value='/config_notifications_channel, /config_notification_role', inline=False)
    embed.add_field(name='📺 Streams', value='/config_stream_channel, /add_streamer, /remove_streamer', inline=False)
    embed.add_field(name='🎫 Tickets', value='/ticket, /close, /config_ticket_category', inline=False)
    ...
    embed.add_field(name='ℹ️ Información', value='/ping, /info, /ayuda', inline=False)
    
    embed.set_footer(text='Sistema de Ayuda v1.0')
...
async def create_verification_message(interaction: discord.Interaction):
    ...
    if 'servers' not in data or server_id not in data['servers']:
        await interaction.response.send_message('❌ Primero configura el sistema de verificación', ephemeral=True)
        return
